...
void Lab2::Init()
{
...

    {
        ...
        {
            VertexFormat(glm::vec3(-2, -2, 0), glm::vec3(1, 0, 0), glm::vec3(0.1, 0.3, 0.7)),  //a r 0
            VertexFormat(glm::vec3(-2, -2, 0), glm::vec3(1, 1, 1), glm::vec3(0.1, 0.3, 0.7)), //a w 1
            VertexFormat(glm::vec3(-2, -2, 0), glm::vec3(0, 0, 1), glm::vec3(0.1, 0.3, 0.7)), //a b 2



            VertexFormat(glm::vec3(2, -2, 0), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)), //b w 3
            VertexFormat(glm::vec3(2, -2, 0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //b g 4
            VertexFormat(glm::vec3(2, -2, 0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //b b 5


            VertexFormat(glm::vec3(0, -1, 4), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //c r 6
            VertexFormat(glm::vec3(0, -1, 4), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), // c g 7
            VertexFormat(glm::vec3(0, -1, 4), glm::vec3(1, 1, 1), glm::vec3(0.2, 0.8, 0.6)),// c w 8



            VertexFormat(glm::vec3(0,2,0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)), //d r 9
            VertexFormat(glm::vec3(0,2,0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)), //d g 10
            VertexFormat(glm::vec3(0,2,0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)), //d b 11
...

    {
        ...
        {
            VertexFormat(glm::vec3(4,4,0), glm::vec3(1,0,0), glm::vec3(0.1, 0.3, 0.7)),
           // VertexFormat(glm::vec3(4,4,0), glm::vec3(0, 1, 0), glm::vec3(0.1, 0.3, 0.7)),
            //VertexFormat(glm::vec3(4,4,0), glm::vec3(0, 0, 1), glm::vec3(0.1, 0.3, 0.7)),

            VertexFormat(glm::vec3(8,4,0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            //VertexFormat(glm::vec3(8,4,0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            //VertexFormat(glm::vec3(8,4,0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),


            VertexFormat(glm::vec3(4,8,0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            //VertexFormat(glm::vec3(4,8,0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            //VertexFormat(glm::vec3(4,8,0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),



            VertexFormat(glm::vec3(8,8,0), glm::vec3(1, 0, 0), glm::vec3(0.2, 0.8, 0.6)),
            //VertexFormat(glm::vec3(8,8,0), glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            //VertexFormat(glm::vec3(8,8,0), glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
...

{
    ...
    // aici va fi aia cu toggle

    // Render an object using face normals for color
    RenderMesh(meshes["box"], shaders["VertexNormal"], glm::vec3(1.5f, 0.5f, -1.5f), glm::vec3(0.75f));

    //RenderMesh(meshes["box"], shaders["VertexNormal"], glm::vec3(1.5f, 3.5f, -1.5f), glm::vec3(0.75f));

    // Render an object using colors from vertex
    RenderMesh(meshes["cube_A"], shaders["VertexColor"], glm::vec3(-1.5f, 0.5f, -1.5f), glm::vec3(0.25f));
    ...
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 3), glm::vec3(0.25f));

    // TODO(student): Draw the square

    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 3), glm::vec3(0.25f));

    ...
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            forward = glm::normalize(rotationMatrix * glm::vec4(forward, 1));
            up = glm::normalize(rotationMatrix * glm::vec4(up, 1));
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            right = glm::normalize(rotationMatrix * glm::vec4(right, 1));
            forward = glm::normalize(rotationMatrix * glm::vec4(forward, 1));
        ...
        void RotateThirdPerson_OX(float angle)
        {
            ...
            position = position + distanceToTarget * right;
